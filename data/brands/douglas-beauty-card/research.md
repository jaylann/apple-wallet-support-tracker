...
|---|---|---|---|
| https://apps.apple.com/lt/app/douglas-perfumes-cosmetics/id394685685 | official | 2026-07-11 | Douglas app App Store listing — the app hosts the digital Beauty Card and its Add to Wallet flow. |
| https://thalia-drs.de/case-studies/beauty-card-douglas-case-study | press | 2026-07-11 | Case study: the Douglas Beauty Card can be added to the smartphone wallet to collect Beauty Points and redeem bonuses. |
