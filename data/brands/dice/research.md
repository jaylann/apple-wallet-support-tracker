...
DICE deliberately keeps tickets in-app to combat resale. No Wallet path is offered.
...
- **2026-07-13** (sweep, claude-subagent) — Confirmed nativePkpass=none unchanged; DICE/Fever continues in-app-only ticket model with no Apple Wallet path; help centre and App Store listing show no change post-Fever acquisition. Source: [DICE: Live Shows – App Store](https://apps.apple.com/us/app/dice-live-shows/id898358948).
- **2026-08-01** (sweep, claude-subagent) — Confirmed nativePkpass=none unchanged; DICE/Fever in-app-only model persists; no Apple Wallet integration found post-acquisition. Source: [DICE: Live Shows – App Store](https://apps.apple.com/us/app/dice-live-shows/id898358948).
